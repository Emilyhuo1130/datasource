...
<div id="part2" >
  ...
  <div id="sub_nav">
    <ul>
      ...
      <li class="list_item">
        <a href="_notification_ticket_2.jsp" style="color:#0989aa;">预警告警维保通知单</a>
      </li>
       <li class="list_separator">
        |
      </li>
  ...
  <div>
    <div style="display:inline-block;">
      <div id="query_criteria" style="padding-top: 0px; width: 100%;">
        ...
        <a style="float: right" class="button_query" onclick="selectNotifyData(1,'故障预警');" >
        </a>
        </div>
     </div>
    </div>
...
<div style="height:308px;border-right:1px solid black;"><!-- 分边 -->
  <div style="background-image: url('../../images/table_background.png');height:300px;">
    ...
    <div id="query_result_footer_current_page">
      <img src="../../images/previous_triangle.png"  onclick="tobackpage('故障预警');" />
      		第 <span id="notify_page_nowpage">0</span> 页
      <img src="../../images/previous_triangle.png" onclick="tonextpage('故障预警');"; style="transform:rotate(180deg);-webkit-transform:rotate(180deg);" />
    </div>
