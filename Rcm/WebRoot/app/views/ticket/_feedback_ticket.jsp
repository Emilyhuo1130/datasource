...
<div id="part2" >
  ...
  <div id="sub_nav">
    <ul>
      <li class="list_item">
        <a  href="_feedback_ticket.jsp" style="color:#0989aa;">故障告警维修反馈记录</a>
      </li>
  ...
  <div>
    <div style="display:inline-block;">
      <div id="query_criteria" style="padding-top: 0px; width: 100%;">
        ...
        <a style="float: right" class="button_query" onclick="selectMaintenceData(1,'故障告警');" >
        </a>
     </div>
    </div>
  </div>
...
<div style="height:390px;border-right:1px solid black;">
  ...
  <div id="query_result_footer">
    <div id="query_result_footer_current_page">
      <img src="../../images/previous_triangle.png"  onclick="maintence_backpage('故障告警');"/>
     	 第<span id="maintence_page_nowpage">0</span> 页
      <img src="../../images/previous_triangle.png" style="transform:rotate(180deg);-webkit-transform:rotate(180deg);" onclick="maintence_nextpage('故障告警');"/>
    </div>
