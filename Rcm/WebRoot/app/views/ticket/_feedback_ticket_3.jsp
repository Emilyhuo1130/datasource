...
<div id="part2" >
  ...
  <div id="sub_nav">
    <ul>
      ...
      <li class="list_item">
        <a href="_feedback_ticket_2.jsp" >预警告警维修反馈记录</a>
      </li>
      <li class="list_separator">
        |
      </li>
      <li class="list_item">
        <a href="_feedback_ticket_3.jsp" style="color:#0989aa;">计划预警维修反馈记录</a>
      </li>
    </ul>
  </div>
  ...
  <div>
    <div style="display:inline-block;">
      <div id="query_criteria" style="padding-top: 0px; width: 100%;">
        ...
        <a style="float: right" class="button_query" onclick="selectMaintenceData(1,'计划预警');" >
        </a>
     </div>
    </div>
  </div>
...
<div style="height:390px;border-right:1px solid black;">
  ...
  <div id="query_result_footer">
    <div id="query_result_footer_current_page">
      <img src="../../images/previous_triangle.png"  onclick="maintence_backpage('计划预警');"/>
     	 第<span id="maintence_page_nowpage">0</span> 页
      <img src="../../images/previous_triangle.png" style="transform:rotate(180deg);-webkit-transform:rotate(180deg);" onclick="maintence_nextpage('计划预警');"/>
    </div>
