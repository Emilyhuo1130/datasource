...
<script type="text/javascript">
	$(document).ready(function(){
		...
		user1_goto(userName);
	//--------------------------------------------------------------	
		OnNotify_faultAlertQuery(1,"故障告警");
	});
	//通知单的浮动效果函数
...
<div id="part2" >
  ...
  <div id="sub_nav">
    <ul>
      <li class="list_item">
        <a  href="_notification_ticket.jsp" style="color:#0989aa;">故障告警维保通知单</a>
      </li>
      ...
      <li class="list_item">
       ...
       <li class="list_item">
        <a href="_notification_ticket_3.jsp">计划预警维保通知单</a>
      </li>
    </ul>
  </div>
    ...
    <div style="display:inline-block;">
      <div id="query_criteria" style="padding-top: 0px; width: 100%;">
        ...
        <div style="position:absolute;top:30%;left:75%;height:20px;">
       	 <a class="button_query" style="float:right;" onclick="selectNotifyData(1,'故障告警');" > </a>
       	 </div>
    </div>
  </div>
</form>
...
<div style="height:308px;border-right:1px solid black;"><!-- 分边 -->
  <div style="background-image: url('../../images/table_background.png');height:300px;">
    ...
    <div id="query_result_footer_current_page">
      <img src="../../images/previous_triangle.png"  onclick="tobackpage('故障告警');" />
      		第 <span id="notify_page_nowpage">0</span> 页
      <img src="../../images/previous_triangle.png" onclick="tonextpage('故障告警');"; style="transform:rotate(180deg);-webkit-transform:rotate(180deg);" />
    </div>
