...
<script type="text/javascript">
	$(document).ready(function(){
		//浮动导航菜单
				...
				//alert(typeof req);
		user1_goto(userName);
		onReport_equipment_Query_Details(req);
...
<div id="part1" >
  ...
  <div id="navigation" >
    	...
    	<div id="alertManage"  class="nav_item_normal" >  <a  href="report_historyAlert_statistics_count.jsp" style="color:#cba300;" >统计报表</a></div>
   </div> 
  </div>
<div id="part2" >
    ...
    <ul>
      <li class="list_item">
        <a  href="report_historyAlert_statistics_count.jsp" style="color:#0989aa;">告警历史统计表</a>
      </li>
