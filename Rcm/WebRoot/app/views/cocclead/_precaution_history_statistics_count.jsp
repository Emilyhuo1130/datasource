...
<div id="mainpage" class="nav_item_main"   >  <a id="Main" href="../cocc/cocclead.jsp" >首页</a></div>
 <div   class="nav_item_normal" > <a  href="report_historyAlert_statistics_count.jsp" style="color:#cba300;">统计报表</a></div>  </div> 
</div>
<div id="part2" >
  ...
  <div id="sub_nav">
    <ul>
      ...
      <li class="list_item">
        <a  href="_precaution_history_statistics_count.jsp" style="color:#0989aa;">预警历史统计表</a>
      </li>
      <li class="list_separator">
        |
      </li>
