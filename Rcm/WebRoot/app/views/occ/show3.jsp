...
<html>
	<head>
       ...
       <script language="JavaScript" src="../../assets/javascripts/jquery.ztree.core-3.5.js"></script> 
 		...
 		<script language="JavaScript" src="../../assets/javascripts/occ-director.js"></script>
 		...
 		<script language="JavaScript" src="../../assets/javascripts/jqueryBlockUI.js"></script> 
 		<script language="JavaScript" src="../../assets/javascripts/jqueryPromit.js"></script> 
