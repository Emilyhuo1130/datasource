...
<html>
	...
	<body>
		<div id="part1" >
    			...
    			<div id="header_title" >
    				<div style="display: inline-block;float: right;">
      				...
      				<div style="display: inline-block;float: right; margin-right: 10px;">
      					 <span style="font-size: 14px; color: yellow; "><%= username%></span>
      				</div>
    			</div>
  			</div>
 			 <div id="navigation" >
    			<div id="mainpage" class="nav_item_main"   >  <a id="Main" href="../occ/application.jsp" style="color:#cba300;">首页</a></div>
		 ...
		 <div id="part2" style="height:900px;">
				<%@include file="../occ/application_sub.jsp" %>
		</div>  
