...
<div style="padding-top: 30px;">
				...
				<div style="height:auto;border-right:1px solid black;"><!-- 分边 -->
				  <div style="background-image: url('../../images/table_background.png');height:auto;">
				    <table id="query_result_table" border="0px" >
				     ...
				     <!--id="query_result_table_body" -->
				     	 <tbody id="query_result_table_body_getMaintain_couple_back" style="border:hidden;color: #8f8f8f;text-align: left;">
				     		<tr>
 ...
 <div id="sc_trend_analysis" class="image_view"  style="width:700px; position:relative;left:250px;top:-700px;">
