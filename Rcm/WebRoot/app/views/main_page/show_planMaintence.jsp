	...
	<body>
     ...
     <!-- 悬浮图片和图表终-->
      					...
      					<table style="padding-left: 20px; padding-top: 12px;">
        					...
        					<tr style="height: 27px;">
         						...
         						<td class="delimiter"></td>
          						...
          						<td style="color: #434343; font-size: 12px;"><a onclick="showPlanMaintenceAlertInfo({'lineNo': '10','statments':'1'});" href="#"><span onmouseover='showDetail(true,10);' onmouseout='showDetail(false,10);' style="font-weight: normal;">十号线</span></a></td>
        					</tr>
        					<tr style="height: 27px;">
		...
		<div style="display:block; float: left; width: 100%; height: 8px;"></div>
  		...
  		<!-- 子菜单始 -->
   	  		<div  style="position:absolute;z-index:100;left:16%;font-size:.85em;"><ul>
		      <li class="list_item">
		        <a  href="../layouts/application.jsp" >故障告警</a>
		      </li>
		      <li class="list_separator">
		        |
		      </li>
		      <li class="list_item">
		        <a href="../layouts/application_pre.jsp">预警告警</a>
		      </li>
		       <li class="list_separator">
		        |
		      </li>
		      <li class="list_item">
		        <a href="application_planMaintence.jsp" style="color:#0989aa;">计划修预警</a>
		      </li>
   	  		</ul></div>
   	  		<!-- 子菜单终-->
     					 ...
     					 <div id="alert_content_query_criteria">
        					...
        					<div id="query_result_footer">
          						<div id="query_result_footer_current_page">
            						<img src="../../images/previous_triangle.png" onclick="backpage_app_plan();" />
            							第<span id="main_page_nowpage">1</span>页
            						<img onclick="nextpage_app_plan();" src="../../images/previous_triangle.png" style="transform:rotate(180deg);-webkit-transform:rotate(180deg);" />
          						</div>
          						<div id="query_result_footer_total_page">
          	 							共<span id="main_page_totalpage">1</span> 页
          						</div>
