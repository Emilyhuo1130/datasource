...
<script type="text/javascript">
  $(document).ready(function(){
	//浮动导航菜单
		...
		user1_goto(userName);
		//---------------------------------------------
 		 OnEmergePageQuery_emerge1({"warningType":"故障预警"});
 		 setTimeout(function(){
  			showFloatInfo();
 		 },100);
...
<div id="part2" >
    ...
    <ul>
      ...
      <li class="list_item">
        <a href="current_faultPrecaution_alert_step0.jsp" style="color:#0989aa;">预警告警</a>
      </li>
       <li class="list_separator">
        |
      </li>
...
<div id="main_alert_content" style="padding-top: 0px; height: 400px; border-bottom: 1px solid gray;" >
