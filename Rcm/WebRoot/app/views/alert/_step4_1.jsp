	...
	<script type="text/javascript">
  			 ...
  			 %>
       		 ...
       		 %> 
  				...
  				showTendChart("#sc_trend_analysis svg",data);
  			});
            </script>
  ...
  <div style="max-width: 72%;display: inline-block; height: 700px;padding-left: 2%;padding-right: 0px;">
    <table style="border-collapse:separate; border-spacing: 10px; text-align: right; width: 100%;">
      ...
      <tr>
        ...
        <td colspan="7">
          <textarea style="height: 60px;background-color: transparent; width: 65%;" placeholder="say something." rows="8" cols="1" id="malfunction_cause" name="malfunction_cause"></textarea>
      ...
      <tr>
        ...
        <td colspan="7">
          <textarea style="height: 60px;background-color: transparent; width: 65%;" placeholder="say something." rows="8" cols="1" id="text_impact" name="text_impact"> </textarea> 
      ...
      <tr>
        ...
        <td colspan="7">
          <textarea style="height:60px;background-color: transparent; width: 65%;" placeholder="say something." rows="8" cols="1" id="strategy" name="strategy"></textarea>
    ...
    <div id="sc_trend_analysis" class="image_view"  style="width:700px; float:right;">
