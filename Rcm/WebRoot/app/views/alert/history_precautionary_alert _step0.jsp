...
<head>
 ...
 <script language="JavaScript" src="../../assets/javascripts/commons.js"></script>
  <script language="JavaScript" src="../../assets/javascripts/emerge1.js"></script>
...
<div id="part2" >
    ...
    <ul>
      <li class="list_item">
        <a  href="history_alert_step0.jsp" style="color:#0989aa;">故障告警</a>
      </li>
      <li class="list_separator">
        |
      </li>
      <li class="list_item">
        <a href="history_precautionary_alert _step0.jsp">预警告警</a>
      </li>
       <li class="list_separator">
        |
      </li>
      <li class="list_item">
        <a href="history_faultMaintence_alert _step0.jsp">计划修预警</a>
      </li>
    </ul>
  </div>
  <!-- 子导航菜单终点 -->
  ...
  <div id="query_result_footer" style="width: 958px;">
    ...
    <div id="query_result_footer_current_page">
        <img src="../../images/previous_triangle.png" onclick="backpage();" />
          	第<span id="user1_emerge_page_nowpage">0</span>页
    ...
    <div id="query_result_footer_total_page">
          	共<span id="user1_emerge_page_totalpage"></span> 页
    </div>
  ...
  <script type="text/javascript">
    ...
    <div id="main_alert_content" style="padding-top: 0px; height: 320px; border-bottom: 1px solid gray;" >
      <div id="alert_content_datagrid" style="margin: 0px; width: 100%; background: none;">
            ...
            <table id="query_result_table" border="0" style="height:210px;">
              <caption>
              </caption>
              <thead>
              <tr id="query_result_table_header">
