...
<html>
	<head>
  	 ...
  	 <script language="JavaScript" src="../../assets/javascripts/jquery.ztree.core-3.5.js"></script> 
 		...
 		<script language="JavaScript" src="../../assets/javascripts/common.js"></script>
    			...
    			<div id="header_title" >
    				<div style="display: inline-block;float: right;">
      				...
      				<div style="display: inline-block;float: right; margin-right: 10px;">
      					 <span id="userName" style="font-size: 14px; color: yellow; "><%=session.getAttribute("username")%></span>
      				</div>
    			</div>
  			</div>
  			<div id="navigation" >
