...
<div id="part1" >
  ...
  <div id="navigation" >
    			<div id="mainpage" class="nav_item_main"   >  <a id="Main" href="../cocc/coccmain.jsp" >首页</a></div>
...
<div id="part2" >
		<div style="margin-top: 20px;">
  		<div id="sub_nav">
   		 <ul>
      		<li class="list_item">
        		<a  href="../event/_sc.jsp" style="color:#0989aa;">综合协调中心总调度</a>
      		</li>
...
<div style="width:938px;height:209px;border-right:0px solid black;">
	...
	<spn style="color:#f8626e;">Cocc调度员<%=session.getAttribute("username")%>,您好!您只能查看occ待处理的记录!</spn> 
	</div>
