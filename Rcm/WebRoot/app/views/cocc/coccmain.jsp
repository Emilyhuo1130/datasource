  ...
  <%String userName =(String)session.getAttribute("username"); %>
	...
	var operator=null;
		...
		//加载待处理的数据
      	...
      	setTimeout(function(){
      		$("#char1 svg text:contains('Stacked')").click(function(){
      			GetAlertCountHistoryPerLevel('#char1 svg');
      	      	GetAlertCountHistoryPerLevel_2('#char2 svg');
      			});
      	},50);
...
<div id="part2" >
		<div style="margin-top: 20px;">
  		<div id="sub_nav">
   		 <ul>
      		<li class="list_item">
        		<a  href="#" style="color:#0989aa;">综合协调中心总调度</a>
      		</li>
...
<div style="position:relative;top:-10px;width:938px;height:150px;border-right:0px solid black;">
<!-- 分边 -->
<div id="query_result">
<div id="alert_content" style="padding-top: 0px; height: 100px; border-bottom: 1px solid gray;border-right: 1px solid gray;" >
  ...
  <div id="query_result_footer" style="width: 936px;border-right: 1px solid gray;">
    <div id="query_result_footer_current_page">
      <img src="../../images/previous_triangle.png" onclick="cocc_backpage();" />
     	 第 <span id="coccmain_page_nowpage">1</span> 页
      <img src="../../images/previous_triangle.png" style="transform:rotate(180deg);-webkit-transform:rotate(180deg);" onclick="cocc_nextpage();"/>
    </div>
    <!--<img src="" />  -->
	...
	--><div  id="showImage2" class='lineInfo' style="width:150px;height:600px; border:0px solid red">
						<img  onMouseOut="cleartext()" usemap="#lineInfoOfTen" src="../../images/line.png" height="600" width="150"/>
						<map name="lineInfoOfTen">
							<area shape=rect coords=20,410,50,440 href="occmain.jsp">
						</map>
    </div>
	...
	<div id="nextimage" style="display: none;background: url('../../images/COCCMAIN-2.png');width: 936px;height: 795px;">
		...
		<table style="padding-top: 120px;" >
			...
			<td >
				...
				<div id="char1" style="width:445px;height:332px; border:0px solid red;" >
					<svg style="width:445px;height:332px;"fill=white>
			...
			<td width=30px></td>
			<td >
				<div id="char2" style="width:445px;height:332px; border:0px solid red;" >
					<svg style="width:445px;height:332px;"fill=white>
						<script>
							d3.select("#char2 svg");
						</script>
