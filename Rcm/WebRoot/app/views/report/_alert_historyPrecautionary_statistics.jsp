...
<script language="JavaScript" src="../../assets/javascripts/jquery-1.4.4.min.js"></script>
 ...
 <script type="text/javascript">
	$(document).ready(function(){
		...
		user1_goto(userName);
		showFultureReportInfo_Details_alert();
...
<!-- 子导航菜单始点 -->
    ...
    <ul>
      <li class="list_item">
        <a  href="_alert_history_statistics.jsp" >故障告警</a>
      </li>
      <li class="list_separator">
        |
      </li>
      <li class="list_item">
        <a href="_alert_historyPrecautionary_statistics.jsp" style="color:#0989aa;">预警告警</a>
      </li>
       <li class="list_separator">
        |
      </li>
      <li class="list_item">
        <a href="_alert_historyPlanmaintence_statistics.jsp">计划修预警</a>
      </li>
    </ul>
  </div>
  <!-- 子导航菜单终点 -->
 ...
 <div id="query_result_footer">
    <div id="query_result_footer_current_page" >
      <img src="../../images/previous_triangle.png"  onclick="report_pre_backpage();"/>
     	 第<span id="report_pre_page_nowpage">1</span> 页
    ...
    <div id="query_result_footer_total_page">
     	 共<span id="report_pre_page_totalpage">1</span> 页
    </div>
