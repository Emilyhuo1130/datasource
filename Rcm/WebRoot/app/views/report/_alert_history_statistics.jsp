...
<script type="text/javascript">
	$(document).ready(function(){
		...
		user1_goto(userName);
		onReport_equipment_Query_Details_alert();
...
<div id="part2" >
    ...
    <ul>
      <li class="list_item">
        <a  href="../report/_alert_history_statistics.jsp" style="color:#0989aa;">故障告警</a>
      </li>
      ...
      <li class="list_item">
        <a href="../report/_alert_historyPlanmaintence_statistics.jsp">计划修预警</a>
      </li>
    </ul>
  </div>
  <!-- 子导航菜单终点 -->
  ...
  <br/>
      ...
      <div id="time_range">
        ...
        <a style="float: right" class="button_query" onclick="query_report_history();" >
        </a>
      </div>
      </div>
    </div>
...
<div id="query_result" style="padding-left:10px;width:938px;margin-top: 0px;height:400px;" >
 ...
 <div id="query_result_footer" >
    <div id="query_result_footer_current_page">
      <img src="../../images/previous_triangle.png"  onclick="historyAlert_backpage();"/>
     	 第<span id="report_page_nowpage">0</span> 页
      <img src="../../images/previous_triangle.png" style="transform:rotate(180deg);-webkit-transform:rotate(180deg);" onclick="historyAlert_nextpage();"/>
    </div>
