...
<div id="part2" >
  ...
  <div id="sub_nav">
    <ul>
      ...
      <li class="list_item">
        <a href="../report/_rcm_ticket.jsp" style="color:#0989aa;">主动维保通知单</a>
      </li>
      <li class="list_separator">
        |
      </li>
  ...
  <div>
    <div style="display:inline-block;">
      <div id="query_criteria" style="padding-top: 14px;" >
        ...
        <label for="operation_condition3"></label>
        <select id="operation_condition3" class="combobox" name="criteria[condition3]">
          <option value="">线路</option>
	          <option value="10">10号线</option>
        </select>
        <label for="operation_condition4"></label>
        <select id="operation_condition4" class="combobox" name="criteria[condition4]">
          <option value="">车站</option>
         <option value="航中路站">航中路站</option>
         <option value="紫藤路">紫藤路</option>
         <option value="龙柏新村">龙柏新村</option>
        </select>
        <label for="operation_condition5"></label>
        <select id="operation_condition5" class="combobox" name="criteria[condition5]">
  ...
  <div id="query_result_footer" >
    <div id="query_result_footer_current_page">
      <img src="../../images/previous_triangle.png"  onclick="report_noti_backpage();"/>
     	 第<span id="operation_noti_page_nowpage">0</span> 页
    ...
    <div id="query_result_footer_total_page">
     	 共<span id="operation_noti_page_totalpage"></span> 页
    </div>
     <div style="float: right; padding-right: 20px;">
     	 共<span id="operation_noti_page_totalCount" style="text-align:right;"></span> 条记录
    </div>
  </div>
  <script type="text/javascript">
    /*OnAlertQuery();*/
