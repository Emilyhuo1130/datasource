  ...
  <div style="background-color: #f9f9fb; border-left: 1px solid gray;border-right: 1px solid gray; padding-bottom: 20px;">
    <div style="display:inline-block; width: 920px; ">
      <div id="query_criteria" style="width: 100%;">
        ...
        -->
        <a style="display: inline-block;vertical-align: middle;" class="button_query" onclick="findFaultInfoOnAlertQueryimpact();" >
        </a>
      </div>
    </div>
  </div>
  ...
  <div id="device_tree_info" style="float:none; width: 550px;height: 500px;">
    ...
    <table style="width: 492px; height: 100px;">
      <tr>
        ...
        <!--
        <td style="width: 80px; text-align: center;">
          <label for="asset_id" class="label_text">资产编号</label>
        </td>
        <td style="width: 120px;">
      ...
      <tr>
        ...
        <td style="">
          <textarea style="background-color: transparent; width: 100%;" placeholder="say something." rows="8" cols="1" id="malfunction_desc" name="malfunction_desc"></textarea>
        </td>
      </tr>

      <tr>
        <td style="text-align: center;">
          <label for="malfunction_impact" class="label_text">运营影响</label>
        </td>
        <td>
          <textarea style="background-color: transparent; width: 100%;" placeholder="say something." rows="8" cols="1" id="malfunction_impact" name="malfunction_impact"></textarea>
        </td>
      </tr>
      <tr>
        <td style="">
