...
public class Receiver extends JFrame implements ReceiveStreamListener,ControllerListener{
	...
	public static void main(String[] args) throws InvalidSessionAddressException {
		try {
	...
	public Receiver(SessionAddress local, SessionAddress target) throws InvalidSessionAddressException {
