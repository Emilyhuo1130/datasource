...
public class Sender {
	...
	public static void main(String[] args) throws NoProcessorException, InvalidSessionAddressException, UnsupportedFormatException {	
	...
	public Sender(SessionAddress local,SessionAddress target) throws NoProcessorException, InvalidSessionAddressException, UnsupportedFormatException {
