	...
	<tr >
	    <td>
		    ...
		    <table>
				    ...
				    <td >
				        <input height="25px" onblur="veriftycharacter(this,'errorNameChar');" name="groupName" size="30" id="groupName" type="text"  dataType="LimitB" min="1" max="10" msg="1-20个字符" />
