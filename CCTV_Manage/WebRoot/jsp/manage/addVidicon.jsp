...
<table border="0" cellPadding="" cellspacing="0" >
	<tr>
		<td width=100% height=23 align=left class='page-title' nowarp>
			...
			&nbsp; &nbsp;<span id="navigation">添加摄像机配置信息</span>
		</td>
...
<INPUT onblur="veriftycharacter(this,'errorNameChar');"  placeholder="摄像机1" title="填写摄像机名称"  id="u3" type=text value="" class="u3"     >
...
<INPUT onblur="veriftyAllNumber(this,'errorNumberChar');" id="u12" type=text value="" class="u12"   title="填写摄像机的容量大小" placeholder="4000"    >
