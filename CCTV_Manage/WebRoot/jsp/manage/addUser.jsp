...
<table   width="700"  class='table_edit'>
    ...
    <tr>
	    ...
	    <td >
	        ...
	        <input onblur="veriftycharacter(this,'errorNameChar');" placeholder="张三"  title="请输入操作人员姓名" name="userName" size="30" id="userName" type="text"  dataType="LimitB" min="1" max="10" msg="1-20个字符" />
	...
	<tr>
	    ...
	    <td >
	        <input onblur="veriftycharacter(this,'errorAccountChar');" placeholder="zhangsan" title="请输入操作人员的账户" name="userAccount" size="30" id="userAccount" type="text"  />
	       <span style="font-size:15px;color:red" >*</span>
	...
	<tr>
	    ...
	    <td >
	        <input onblur="veriftycharacter(this,'errorpasswordChar')" title="请输入操作人员的密码" name="userpassword" size="30" id="userpassword" type="text"  />
	        <span style="font-size:15px;color:red" >*</span>
	...
	<tr>
	    ...
	    <td >
	        <input onblur="veriftyPhoneNumber(this,'errorPhoneChar');" placeholder="13921219802" title="请输入操作人员的手机号" name="phoneNumber" size="30" id="phoneNumber" type="text"  dataType="LimitB" min="1" max="20" msg="内容为11个字节" />
	        <span style="font-size:15px;color:red" >*</span>
	...
	<tr>
	    ...
	    <td >
	        ...
	        <span style="display:none;color:red" id="errorChar" >非法字符</span>
	    </td>
	</tr>
 </p>
	<tr>
...
<div id="save_button">
	<input type="button"  onclick="saveUserInfo();" id="saveInfo"  class="adduserSave" value="保存"/>
