...
public class DayExpenseProject extends BaseUserInfo{
	...
	private int travelCost;//旅游支出
	private int otherTheBusFee;//另外的公交费/汽油费
	private int friendCost;//芳沁好友费用支出
	private int otherSocialCost;//其他的社交
	private int cosmeticCost;//化妆品支出
	private int hygienicProductsCost;//个人卫生用品支出
	private int articlesOfDailyUseCost;//生活用品支出
	private int officeSuppliesCost;//办公用品支出
	private int otherDailySuppliesCost;//其他日常用品消费
