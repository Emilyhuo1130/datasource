...
<head>
	...
	$(document).ready(function(){
		...
		setPageNum($("#current_page").html(),totalpages);
...
function conditionSearch(current_page){
	        ...
	        success : function(response) {  
	        	...
	        	$("#startWeek option").each(function(i,e){
	        		...
	        		if($e.val()==thisWeekNumber){
	        			$("#startWeek option:eq("+(i+1)+")").attr("selected","selected");
	        			$("#endWeek option:eq("+(i+1)+")").attr("selected","selected");
	        		}
	...
	function  setPageNum(current_page,total_page,condition){
		...
		$("#last_page").click(function(){
			...
			conditionSearch(total_page,condition);
		});
	};
	
			//showFloatStack(jqueryNode,text);
</script>
</head>
<body>
