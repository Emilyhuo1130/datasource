...
public class ProjectInfoDAO extends BaseHibernateDAO {
	...
	public List findByExample(ProjectInfo instance) {
		log.debug("finding ProjectInfo instance by example");
		try {
			List results = getSession().createCriteria("com.pojo.ProjectInfo")
